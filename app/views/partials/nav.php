<header class="pt-36 pt-16 xl:pt-20 2xl:pt-24">
    ...
    >
          ...
          <li class="mr-3">
            <a
              class="
                ...
                hover:translate-y-1
              "
              href="<?php echo URLROOT; ?>/productos"
              @click="isOpen = false"
              >PRODUCTOS
            </a>
          </li>
      ...
      <button class="whis-list">
        <svg 
          class="cursor h-6 w-6 fill-current text-main ml-2"
      ...
      <svg
        class="cursor h-6 w-6 fill-current text-main ml-6"
        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
